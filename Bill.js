function checkUnit(){
	...
	let pre = Number(document.getElementById('PUnit').value);
	let cur = Number(document.getElementById('CUnit').value);
	let unit = cur-pre;
	let txtResult = document.getElementById('UnitResul');
	var amount=0;
	if(unit<=0){
		amount="invalid";
	}
	...
	txtResult.innerHTML = "<h3>No.of used unit:"+unit+"units<br>Total Payable to CEB:"+amount+".Rs</h3>";
